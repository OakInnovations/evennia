from evennia.contrib.lineeditor import LineEditor
import evennia
...
class CmdDig(BaseCreationCommand):
    """
    Create a new room. Usage:

    Usage: @dig room name;room alias 1;room alias 2
    """
    key = '@dig'
    help_category = "Building"
...
class CmdOpen(BaseCreationCommand):
    ...
    Usage: @open Exit name;exit alias 1;exit=room
    """
    key = '@open'
